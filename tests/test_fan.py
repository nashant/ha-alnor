...
async def test_fan_setup(
    ...
    # Verify fan entities were created
    state = hass.states.get("fan.living_room_hru")
...
async def test_fan_turn_on(
    ...
    with (
        ...
        await hass.services.async_call(
            ...
            SERVICE_TURN_ON,
            {
                ATTR_ENTITY_ID: "fan.living_room_hru",
                ATTR_PERCENTAGE: 75,
            },
            blocking=True,
        )

        mock_hru_controller.set_speed.assert_called_with(75)
...
async def test_fan_set_percentage(
    ...
    with (
        ...
        mock_hru_controller.set_speed.assert_called_with(80)
