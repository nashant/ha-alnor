> **🤖 AI-Generated Code**: This entire integration was generated by [Claude Code](https://claude.com/claude-code).
...
- 🔌 **Dual-mode operation**: Cloud API + Local Modbus TCP for faster response
- 🔍 **Automatic discovery**: Finds all your devices instantly
- 🏠 **Area synchronization**: Maps devices to Home Assistant areas
- 📊 **Comprehensive monitoring**: Temperature, humidity, CO2, fan speeds, and more
- 🎛️ **Full control**: Speed, modes, schedules, and filter management
- ⚡ **Offline capable**: Local Modbus connections work without internet
...
- **Sync zones** ✅ (Optional): Automatically create Alnor zones matching your Home Assistant areas
...
- ✅ Connect to Alnor cloud
- ✅ Discover all bridges (gateways)
- ✅ Discover all connected devices
- ✅ Create entities for each device
- ✅ Assign devices to areas (if zones synced)
...
- ⚡ Faster response times (< 100ms vs 1-2s)
...
#### 🌡️ Temperature-Based Ventilation
...
|------|---------|---------|-------|
| **Cloud API** | 1-2 seconds | ❌ No | Automatic |
| **Local Modbus** | < 100ms | ✅ Yes | Manual IP config |
...
2. Check logs for import errors: **Settings** → **System** → **Logs**
...
3. Reload integration: **⋮** menu → **Reload**
